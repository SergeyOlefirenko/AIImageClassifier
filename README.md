...
70% – обучающая 20% – валидационная 10% – тестовая
...
Для удобства пользователя реализован интерфейс, позволяющий: Загружать изображение. Применять методы улучшения качества (удаление шума и увеличение разрешения). Сохранять результаты в файл. Изменять тему интерфейса между светлой и темной.
...
Итоговые метрики:
Train Accuracy: 93.16% Validation Accuracy: 93.15% Precision: 92.55% Recall: 93.87% Общая Accuracy: 93.22%
